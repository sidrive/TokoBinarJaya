package com.motor.binar.jaya.data.model;
...
public class Motor {
    ...
    public Motor(@NonNull String idbarang, @NonNull String userid, @NonNull String nama_barang, @NonNull String barcode, @NonNull int jumlah_barang, @NonNull String kategori) {
