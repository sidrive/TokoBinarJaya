...
public class EditMotorActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("editmotor", "onCreate: "+motor );
    }
...
//        BaseApplication.get(this).createEditMotorComponent(this);
    ...
    private void validate() {
        ...
        if (cancel) {
            ...
            motor.setNama_barang(nama);
            motor.setBarcode(barcodeid);
            motor.setJumlah_barang(Integer.valueOf(jmlBrg.getText().toString()));
            if (kategoriVal != 5) {
                motor.setKategori(kategoriBarang);
            }
            else {
                presenter.saveBarangs(motor);
            }
        }
    }
